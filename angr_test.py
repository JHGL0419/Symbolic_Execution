...
# proj.hook(0x140001450, scanf, length=0x53)
...
# # entry_state.mem[0x5fee10].uint64_t = 0x123456
# # print(entry_state.mem[0x5fee10].uint64_t)

# # print(hex(list['RFLAGS']))
